document.addEventListener("DOMContentLoaded", function () {
    ...
    let form_input = document.querySelectorAll('.input_form');
    if (form_input) {
    ...
    if (quiz_form) {
        ...
        let PrevBtn1 = quiz_form.querySelector('.btnPrev1');
        let PrevBtn2 = quiz_form.querySelector('.btnPrev2');
        let PrevBtn3 = quiz_form.querySelector('.btnPrev3');
        let PrevBtn4 = quiz_form.querySelector('.btnPrev4');
        let nextBtn = quiz_form.querySelector('.btnNext');
        let nextBtn1 = quiz_form.querySelector('.btnNext1');
        let nextBtn2 = quiz_form.querySelector('.btnNext2');
        let nextBtn3 = quiz_form.querySelector('.btnNext3');
        let nextBtn4 = quiz_form.querySelector('.btnNext4');
...
let step3_1 = document.querySelectorAll('.step3-1');
